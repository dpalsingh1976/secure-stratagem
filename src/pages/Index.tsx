...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4 font-heading">
                Upload Your Policy & Get <span className="text-secondary">AI Analysis</span>
              </h2>
              <p className="text-xl text-muted-foreground">
                Let AI analyze your insurance policy to uncover gaps and opportunities
              </p>
            </div>

            <Card className="card-financial border-2 border-secondary/20 hover:border-secondary/40 transition-all">
              <CardContent className="p-12">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-semibold mb-4">Smart Policy Assistant</h3>
                  <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                    Upload your insurance policy documents (PDF or DOC) and our AI will analyze coverage, identify gaps, and suggest improvements.
                  </p>
      ...
      {/* Members Only Strategies Section */}
      <section className="section-padding bg-gradient-to-br from-primary/5 to-accent/5 relative overflow-hidden">
        ...
        <div className="container-financial relative">
          <div className="max-w-4xl mx-auto">
            <Card className="card-financial border-2 border-accent/30 overflow-hidden">
              <div className="relative">
                ...
                <div className="absolute inset-0 backdrop-blur-sm bg-white/60 z-10 flex items-center justify-center">
                  <div className="text-center px-6">
                    ...
                    <p className="text-muted-foreground mb-6">
                      Access exclusive retirement strategies and advanced planning tools
                    </p>
                ...
                <CardHeader className="pb-8 pt-12">
                  ...
                  <CardDescription className="text-lg text-center">
                    Unlock premium content including tax diversification, infinite banking concepts, and more
                  </CardDescription>
                </CardHeader>
                <CardContent className="pb-12">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1">Tax-Free Wealth Building</h4>
                        <p className="text-sm text-muted-foreground">Learn strategies to accumulate wealth without tax drag</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-secondary flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-semibold mb-1">Infinite Banking Concept</h4>
                        <p className="text-sm text-muted-foreground">Become your own banker with properly structured policies</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-secondary flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-semibold mb-1">IUL Optimization</h4>
                        <p className="text-sm text-muted-foreground">Maximize indexed universal life insurance benefits</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-secondary flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-semibold mb-1">Legacy Planning</h4>
                        <p className="text-sm text-muted-foreground">Create generational wealth transfer strategies</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
