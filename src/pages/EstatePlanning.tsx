...
const EstatePlanning = () => {
  const benefitCards = [
    {
      ...
      description: "Without a Will, state law dictates who gets your assets. Make sure your wishes are known and legally documented."
    },
    {
      icon: Shield,
      title: "Takes Care of Your Children",
      description: "Name a Guardian in your Will to avoid courts deciding who has care, custody, and control of your children."
    },
    {
      icon: Clock,
      title: "Avoid Probate",
    ...
    },
    {
      ...
      description: "Medical Power of Attorney and Living Will let you decide who makes healthcare decisions if you're unable."
    }
  ];
  ...
  const documents = [
    {
      ...
      description: "A legal document that directs how your assets should be distributed after death. It also names guardians for minor children and an executor to manage your estate through probate."
    },
    {
      title: "Revocable Living Trust",
      description: "A legal arrangement that holds your assets during your lifetime and transfers them to beneficiaries after death without probate. You maintain full control and can modify it anytime."
    },
    {
      title: "Medical Power of Attorney",
      description: "Designates a trusted person to make healthcare decisions on your behalf if you become incapacitated and cannot communicate your wishes."
    },
    {
      title: "Living Will / Advanced Directive",
      description: "Documents your end-of-life care wishes, including preferences about life support, resuscitation, and other medical interventions."
    },
    {
      title: "Financial Power of Attorney",
      description: "Designates someone to manage your financial affairs, pay bills, and handle business matters if you become unable to do so yourself."
    },
    {
      title: "HIPAA Authorization",
      description: "Allows designated persons to access your medical information and communicate with healthcare providers on your behalf."
    }
  ];
  ...
  const faqItems = [
    {
      ...
      answer: "If you die without a Will (called 'intestate'), state laws determine how your assets are distributed. This typically means assets go to your closest relatives in a predetermined order, which may not match your wishes. Courts will also decide who becomes guardian of any minor children."
    },
    {
      question: "Can I change my estate plan later?",
      answer: "Yes, you can and should update your estate plan as life circumstances change. Revocable trusts and wills can be amended or completely rewritten. Major life events like marriage, divorce, birth of children, or significant asset changes are good times to review your plan."
    },
    {
      question: "What's the difference between an executor and a trustee?",
      answer: "An executor is named in your Will to manage your estate through probate court after death. A trustee manages assets held in a trust, which can begin during your lifetime. A trustee can serve both while you're alive (if incapacitated) and after death, avoiding probate entirely."
    },
    {
      question: "Do I need both a Will and a Trust?",
      answer: "Many estate plans include both. A Trust handles assets placed into it and avoids probate. A 'pour-over' Will acts as a safety net, directing any assets not in the trust to be transferred to it after death. The Will also names guardians for minor children."
    },
    {
      question: "How often should I update my estate plan?",
      answer: "Review your estate plan every 3-5 years or whenever major life events occur: marriage, divorce, birth or adoption of children, death of a beneficiary, significant changes in assets, moving to a new state, or changes in tax laws."
    },
    {
      question: "What is a 'pour-over' Will?",
      answer: "A pour-over Will works alongside a living trust. It directs that any assets not already in your trust at death should 'pour over' into the trust. This ensures all assets eventually benefit from your trust's distribution plan, though poured-over assets still go through probate."
    }
  ];
  ...
  const misconceptions = [
    { myth: "I'm too young for estate planning", reality: "Incapacity can happen at any age due to accidents or illness" },
    { myth: "Estate planning is only for the wealthy", reality: "It's about control and protecting your family, not just taxes" },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              A comprehensive guide to understanding wills, trusts, and estate planning. 
              Learn how to protect your family and ensure your wishes are honored.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A comprehensive and up-to-date Estate Plan is critical to protect you and your family. 
              Here are the key reasons everyone needs an estate plan.
            </p>
          </div>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A complete estate plan typically includes several important documents. 
              Understanding each one helps you make informed decisions.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    Probate is the court-supervised legal process that validates a will, 
                    identifies assets, pays debts, and distributes property to heirs.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
                      <Clock className="h-4 w-4 text-destructive" />
                      <span><strong>Time:</strong> 6-18 months (sometimes years)</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Scale className="h-4 w-4 text-destructive" />
                      <span><strong>Cost:</strong> 3-8% of estate value</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Eye className="h-4 w-4 text-destructive" />
                      <span><strong>Privacy:</strong> Public record</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border-primary/20">
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    Assets held in a living trust pass directly to beneficiaries 
                    without court involvement, saving time and money.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
                      <span><strong>Time:</strong> Days to weeks</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
                      <span><strong>Cost:</strong> Minimal administrative fees</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <EyeOff className="h-4 w-4 text-primary" />
                      <span><strong>Privacy:</strong> Completely private</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
      ...
      <section className="py-16 bg-primary/5">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl font-bold text-foreground mb-4">
              Easy. Online. Estate Planning.
            </h2>
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              We partner with NetLaw, an award-winning estate planning service recognized by the 
              American Bar Association with the James I. Keane Award for Innovative Excellence. 
              Their approach is personal, conversational, digital, and done right.
            </p>
            ...
            <div className="text-sm text-muted-foreground">
              <p>For more information: <strong>1-888-604-4789</strong> | Support@netlawinc.com</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="sticky bottom-0 z-40 bg-amber-50 dark:bg-amber-950/50 border-t border-amber-200 dark:border-amber-800 py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-2 text-sm text-amber-800 dark:text-amber-200">
            ...
            <p>
              Educational illustration only—not legal, tax, or investment advice. Consult a qualified professional.
            </p>
          </div>
        </div>
      </div>
